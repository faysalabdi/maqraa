      ...
      <div className="mt-6 flex h-32 items-end gap-1.5">
        {days.map((d) => {
          ...
          return (
            ...
            >
              <span
                className={`absolute -top-6 whitespace-nowrap rounded-md bg-fg px-1.5 py-0.5 text-[10px] font-bold text-white group-hover:block ${
                  shown ? "block" : "hidden"
                }`}
              >
                {d.total} XP
              ...
              <div
                className="w-full rounded-t-md bg-gradient-to-t from-brand to-brand-dark transition-all group-hover:shadow-glow-brand"
